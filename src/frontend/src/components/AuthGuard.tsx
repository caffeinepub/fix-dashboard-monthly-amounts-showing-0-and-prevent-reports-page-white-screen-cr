...
import { ChefHat, Loader2, LogIn, UserPlus } from "lucide-react";
          ...
          <CardContent className="space-y-4">
            <div className="rounded-lg bg-muted p-3 sm:p-4 text-xs sm:text-sm">
              ...
              <p className="text-muted-foreground">
                Za korištenje aplikacije potrebno je prijaviti se pomoću
                Internet Identity sustava. Vaši podaci su sigurni i šifrirani.
              </p>
            </div>
            <Button
              onClick={handleLogin}
            ...
            <p className="text-center text-xs text-muted-foreground">
              Prijavom prihvaćate korištenje Internet Identity sustava za
              autentifikaciju
            </p>
          </CardContent>
        </Card>
