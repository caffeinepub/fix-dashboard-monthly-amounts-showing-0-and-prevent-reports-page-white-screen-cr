...
export default function BusinessProfile() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const seats = Number.parseInt(numberOfSeats);
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="mb-8">
        ...
        <p className="text-muted-foreground">
          Unesite kontekstualne parametre vašeg objekta za poboljšanu
          prediktivnu analizu
        </p>
      </div>
      ...
      <div className="mx-auto max-w-3xl">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Ovi podaci će se koristiti za prilagođavanje financijskih
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    setSeasonalActivity(value as SeasonalActivity)
                  }
                  disabled={isReadOnly}
                >
        ...
        <Card className="mt-6 border-primary/20 bg-primary/5">
          <CardHeader>
            <CardTitle className="text-base">
              Kako se koriste ovi podaci?
            </CardTitle>
          </CardHeader>
          <CardContent className="space-y-2 text-sm text-muted-foreground">
            <p>
              • <strong>Lokacija:</strong> Prilagođava projekcije prema
              regionalnim ekonomskim faktorima
            </p>
            <p>
              • <strong>Broj sjedećih mjesta:</strong> Koristi se za procjenu
              potencijala prihoda
            </p>
            <p>
              • <strong>Tip ponude:</strong> Prilagođava analize prema
              različitim operativnim obrascima
            </p>
            <p>
              • <strong>Sezonska aktivnost:</strong> Uzima u obzir sezonske
              varijacije u poslovanju
            </p>
          </CardContent>
        </Card>
      </div>
