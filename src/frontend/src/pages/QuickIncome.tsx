    ...
    <div className="container py-4 sm:py-8 px-4">
      ...
      <div className="mb-6 sm:mb-8">
        <h1 className="text-2xl sm:text-3xl font-bold">
          Brzi unos mjesečnih prihoda
        </h1>
        <p className="mt-2 text-sm sm:text-base text-muted-foreground">
          Unesite ukupne mjesečne prihode za odabranu godinu. Ovi prihodi će
          biti uključeni u sve izvještaje i usporedbe.
        </p>
      </div>
      ...
      <Card className="mb-4 sm:mb-6">
        <CardHeader>
          ...
          <CardDescription className="text-xs sm:text-sm">
            Odaberite godinu za unos mjesečnih prihoda
          </CardDescription>
        </CardHeader>
        <CardContent>
                      ...
                      <div className="flex gap-2">
                        <div className="flex-1">
                          <Input
                            ...
                            value={displayAmount}
                            onChange={(e) =>
                              handleAmountChange(month.value, e.target.value)
                            }
