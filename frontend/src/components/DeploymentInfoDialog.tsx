...
export default function DeploymentInfoDialog() {
  ...
  const frontendPublicUrl = frontendCanisterId !== 'N/A' 
    ? `https://${frontendCanisterId}.icp0.io` 
    : 'N/A';
  
  const backendPublicUrl = backendCanisterId !== 'N/A'
    ...
    <Dialog>
      ...
      <DialogContent className="sm:max-w-[650px] max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Detalji o trenutnoj implementaciji aplikacije na Internet Computer mreži
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-6 py-4">
          ...
          <div className="space-y-4 rounded-lg border bg-muted/30 p-4">
            <h3 className="text-sm font-bold text-primary">Frontend Canister</h3>
            ...
            <div className="space-y-2">
              ...
              <div className="flex gap-2">
                ...
                <Button
                  variant="outline"
                  size="icon"
                  onClick={() => handleCopy(frontendCanisterId, 'Frontend Canister ID')}
            ...
            <div className="space-y-2">
              ...
              <div className="flex gap-2">
                ...
                <Button
                  variant="outline"
                  size="icon"
                  onClick={() => handleCopy(frontendPublicUrl, 'Frontend javni URL')}
            ...
            <div className="space-y-2">
              ...
              <div className="flex gap-2">
                ...
                <Button
                  variant="outline"
                  size="icon"
                  onClick={() => handleCopy(backendCanisterId, 'Backend Canister ID')}
            ...
            <div className="space-y-2">
              ...
              <div className="flex gap-2">
                ...
                <Button
                  variant="outline"
                  size="icon"
                  onClick={() => handleCopy(backendPublicUrl, 'Backend javni URL')}
          ...
          <div className="rounded-lg border bg-muted/50 p-4">
            <h4 className="mb-2 text-sm font-semibold">Status implementacije</h4>
            <div className="space-y-1 text-sm text-muted-foreground">
              <p>
                <span className="font-medium">Mreža:</span> Internet Computer (Mainnet)
              </p>
              <p>
                <span className="font-medium">Frontend status:</span>{' '}
                <span className={`font-medium ${frontendCanisterId !== 'N/A' ? 'text-green-600' : 'text-orange-600'}`}>
                  {frontendCanisterId !== 'N/A' ? 'Aktivno' : 'Nije implementirano'}
                </span>
              </p>
              <p>
                <span className="font-medium">Backend status:</span>{' '}
                <span className={`font-medium ${backendCanisterId !== 'N/A' ? 'text-green-600' : 'text-orange-600'}`}>
                  {backendCanisterId !== 'N/A' ? 'Aktivno' : 'Nije implementirano'}
                </span>
              </p>
              <p>
            ...
            <div className="flex gap-2">
              ...
              <div className="space-y-1 text-sm">
                ...
                <p className="text-muted-foreground">
                  Ove informacije prikazuju trenutnu implementaciju aplikacije na Internet Computer blockchain mreži.
                  Frontend javni URL omogućava pristup aplikaciji s bilo kojeg uređaja putem sigurne HTTPS veze.
                  Backend javni URL omogućava direktan pristup API-ju za napredne integracije.
                </p>
              </div>
            </div>
          </div>
